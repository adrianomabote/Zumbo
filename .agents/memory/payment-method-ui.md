...
No checkout, M-Pesa e e-Mola são uma única opção visual, apresentada como “e-Mola / M-Pesa”. O método específico deve ser inferido pelo prefixo do número, sem obrigar o utilizador a escolher entre dois cartões.
