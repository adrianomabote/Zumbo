...
const BUNDLES = new Map([
  ...
  ['n05',{label:'1024 MB',price:25,  cat:'normal'}],['n06',{label:'1100 MB',price:28,  cat:'normal'}],
  ['n07',{label:'1600 MB',price:41,  cat:'normal'}],['n08',{label:'2048 MB',price:50,  cat:'normal'}],
  ['n09',{label:'3072 MB',price:75,  cat:'normal'}],['n10',{label:'4096 MB',price:100, cat:'normal'}],
  ['n11',{label:'5120 MB',price:125,  cat:'normal'}],['n12',{label:'6144 MB',price:150, cat:'normal'}],
  ['n13',{label:'7168 MB',price:175,  cat:'normal'}],['n14',{label:'8192 MB',price:200, cat:'normal'}],
  ['n15',{label:'9216 MB',price:225,  cat:'normal'}],['n16',{label:'10240 MB',price:250,cat:'normal'}],
  ['p01',{label:'1700 MB',price:57,  cat:'premium'}],['p02',{label:'2600 MB',price:83,  cat:'premium'}],
  ['p03',{label:'3400 MB',price:100, cat:'premium'}],['p04',{label:'4000 MB',price:135, cat:'premium'}],
  ['p05',{label:'5400 MB',price:160, cat:'premium'}],['p06',{label:'6200 MB',price:180, cat:'premium'}],
  ['p07',{label:'9500 MB',price:280, cat:'premium'}],
  ['s01',{label:'1741 MB',price:49,  cat:'sete'}],  ['s02',{label:'2970 MB',price:85,  cat:'sete'}],
  ['s03',{label:'3482 MB',price:90,  cat:'sete'}],  ['s04',{label:'5325 MB',price:145, cat:'sete'}],
  ['s05',{label:'7270 MB',price:200, cat:'sete'}],  ['s06',{label:'11000 MB',price:290,cat:'sete'}],
...
const PUBLIC_INFO_PAGES = {
  ...
  '/megas-baratos-vodacom': {
    ...
    sections: [
      ...
      {
        heading: 'Como escolher um pacote acessível',
        steps: [
  ...
  const CAT_DATA = {
    diarias: {
      ...
      pkgs: [
        ...
        {id:'n05',name:'Diário 25', size:'1024 MB',price:25,  dur:'1 dia(s)'},
        {id:'n06',name:'Diário 28', size:'1100 MB',price:28,  dur:'1 dia(s)'},
        {id:'n07',name:'Diário 41', size:'1600 MB',price:41,  dur:'1 dia(s)'},
        {id:'n08',name:'Diário 50', size:'2048 MB',price:50,  dur:'1 dia(s)'},
        {id:'n09',name:'Diário 75', size:'3072 MB',price:75,  dur:'1 dia(s)'},
        {id:'n10',name:'Diário 100',size:'4096 MB',price:100, dur:'1 dia(s)'},
        {id:'n11',name:'Diário 125',size:'5120 MB',price:125, dur:'1 dia(s)'},
        {id:'n12',name:'Diário 150',size:'6144 MB',price:150, dur:'1 dia(s)'},
        {id:'n13',name:'Diário 175',size:'7168 MB',price:175, dur:'1 dia(s)'},
        {id:'n14',name:'Diário 200',size:'8192 MB',price:200, dur:'1 dia(s)'},
        {id:'n15',name:'Diário 225',size:'9216 MB',price:225, dur:'1 dia(s)'},
        {id:'n16',name:'Diário 250',size:'10240 MB',price:250,dur:'1 dia(s)'},
      ]
    },
    semanais: {
      note: 'ℹ️ Bônus: 100MB extra ao actualizar dentro de 3 dias.',
      pkgs: [
        {id:'p01',name:'Premium 57', size:'1700 MB',price:57,  dur:'3 dia(s)'},
        {id:'p02',name:'Premium 83', size:'2600 MB',price:83,  dur:'3 dia(s)'},
        {id:'p03',name:'Premium 100',size:'3400 MB',price:100, dur:'3 dia(s)'},
        {id:'p04',name:'Premium 135',size:'4000 MB',price:135, dur:'3 dia(s)'},
        {id:'p05',name:'Premium 160',size:'5400 MB',price:160, dur:'3 dia(s)'},
        {id:'p06',name:'Premium 180',size:'6200 MB',price:180, dur:'3 dia(s)'},
        {id:'p07',name:'Premium 280',size:'9500 MB',price:280, dur:'3 dia(s)'},
        {id:'s01',name:'Semanal 49', size:'1741 MB',price:49,  dur:'7 dia(s)'},
        {id:'s02',name:'Semanal 85', size:'2970 MB',price:85,  dur:'7 dia(s)'},
        {id:'s03',name:'Semanal 90', size:'3482 MB',price:90,  dur:'7 dia(s)'},
        {id:'s04',name:'Semanal 145',size:'5325 MB',price:145, dur:'7 dia(s)'},
        {id:'s05',name:'Semanal 200',size:'7270 MB',price:200, dur:'7 dia(s)'},
        {id:'s06',name:'Semanal 290',size:'11000 MB',price:290,dur:'7 dia(s)'},
      ]
    },
    mensais: {
    ...
    infinitas: {
      ...
      pkgs: [
        {id:'d01',name:'Diamante 450', size:'11 GB',price:450,  dur:'30 dia(s)',calls:'Chamadas + SMS ilimitadas'},
        {id:'d02',name:'Diamante 580', size:'15 GB',price:580,  dur:'30 dia(s)',calls:'Chamadas + SMS ilimitadas'},
        {id:'d03',name:'Diamante 720', size:'21 GB',price:720,  dur:'30 dia(s)',calls:'Chamadas + SMS ilimitadas'},
        {id:'d04',name:'Diamante 970', size:'30 GB',price:970,  dur:'30 dia(s)',calls:'Chamadas + SMS ilimitadas'},
        {id:'d05',name:'Diamante 1490',size:'50 GB',price:1490, dur:'30 dia(s)',calls:'Chamadas + SMS ilimitadas'},
      ]
    },
  }
...
.sh-recharge-btn{display:block;width:100%;margin:12px 0 0;padding:17px;border:none;border-radius:14px;font-size:16px;font-weight:700;font-family:inherit;cursor:pointer;background:linear-gradient(135deg,#e53935,#cc0000);color:#fff;transition:opacity .2s;box-shadow:0 -10px 18px rgba(255,255,255,.92);}
...
.res-package-box{text-align:left;}
.res-package-box .res-box-l{text-align:center;margin-bottom:12px;}
.res-package-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;}
.res-package-grid>div{display:flex;flex-direction:column;gap:3px;padding:9px 10px;background:#fff;border:1px solid #ffcdd2;border-radius:9px;}
.res-package-grid span{font-size:10px;color:#8e8e93;text-transform:uppercase;letter-spacing:.05em;}
.res-package-grid strong{font-size:14px;color:#1c1c1e;overflow-wrap:anywhere;}
