...
.sh-recharge-btn{display:block;width:calc(100% + 28px);margin:12px -14px -10px;padding:13px;border:none;border-radius:10px;font-size:14px;font-weight:700;font-family:inherit;cursor:pointer;background:linear-gradient(135deg,#e53935,#cc0000);color:#fff;transition:opacity .2s;box-shadow:0 -10px 18px rgba(255,255,255,.92);}
